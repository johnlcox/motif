...
public final class Case1Cases {
   ...
   */
  public static <T extends Case1<A>, A> DecomposableMatchBuilder0<T> case1(
   ...
   */
  public static <T extends Case1<A>, A, EA extends A> DecomposableMatchBuilder0<T> case1(
      Class<T> clazz, DecomposableMatchBuilder0<EA> a) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<T, EA>(matchers, 0, new Case1FieldExtractor<>(clazz))
        .decomposeFirst(a);
  }
   ...
   */
  public static <T extends Case1<A>, A, EA extends A, A1> DecomposableMatchBuilder1<T, A1> case1(
   ...
   */
  public static <T extends Case1<A>, A, EA extends A, A1, A2> DecomposableMatchBuilder2<T, A1, A2> case1(
   ...
   */
  public static <T extends Case1<A>, A, EA extends A, A1, A2, A3> DecomposableMatchBuilder3<T, A1, A2, A3> case1(
