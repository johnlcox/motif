...
public final class ListConsCases {
   ...
   */
  public static <T, ET extends T> DecomposableMatchBuilder0<List<T>> headNil(
      DecomposableMatchBuilder0<ET> head) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<List<T>, ET>(
   ...
   */
  public static <T, ET extends T, A1> DecomposableMatchBuilder1<List<T>, A1> headNil(
      DecomposableMatchBuilder1<ET, A1> head) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<List<T>, ET>(
        matchers, 0, new ListConsHeadFieldExtractor<>()).decomposeFirst(head);
  }
   ...
   */
  public static <T, ET extends T, A1, A2> DecomposableMatchBuilder2<List<T>, A1, A2> headNil(
      DecomposableMatchBuilder2<ET, A1, A2> head) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<List<T>, ET>(
        matchers, 0, new ListConsHeadFieldExtractor<>()).decomposeFirst(head);
  }
   ...
   */
  public static <T, ET extends T, A1, A2, A3> DecomposableMatchBuilder3<List<T>, A1, A2, A3> headNil(
      DecomposableMatchBuilder3<ET, A1, A2, A3> head) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<List<T>, ET>(
        matchers, 0, new ListConsHeadFieldExtractor<>()).decomposeFirst(head);
  }
  ...
  public static <T> DecomposableMatchBuilder0<List<T>> headTail(
      MatchesExact<T> head, MatchesExact<List<T>> tail) {
    List<Matcher<Object>> matchers =
        Lists.of(ArgumentMatchers.eq(head.t), ArgumentMatchers.eq(tail.t));
  ...
  public static <T> DecomposableMatchBuilder1<List<T>, List<T>> headTail(
      MatchesExact<T> head, MatchesAny<List<T>> tail) {
   ...
   */
  public static <T> DecomposableMatchBuilder0<List<T>> headTail(
      MatchesExact<T> head, DecomposableMatchBuilder0<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.eq(head.t), ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<List<T>, List<T>>(
  ...
  public static <T, B1> DecomposableMatchBuilder1<List<T>, B1> headTail(
      MatchesExact<T> head, DecomposableMatchBuilder1<List<T>, B1> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.eq(head.t), ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<List<T>, List<T>>(
        matchers, 1, new ListConsHeadTailFieldExtractor<>()).decomposeFirst(tail);
  }
  ...
  public static <T, B1, B2> DecomposableMatchBuilder2<List<T>, B1, B2> headTail(
      MatchesExact<T> head, DecomposableMatchBuilder2<List<T>, B1, B2> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.eq(head.t), ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<List<T>, List<T>>(
        matchers, 1, new ListConsHeadTailFieldExtractor<>()).decomposeFirst(tail);
  }
  ...
  public static <T, B1, B2, B3> DecomposableMatchBuilder3<List<T>, B1, B2, B3> headTail(
      MatchesExact<T> head, DecomposableMatchBuilder3<List<T>, B1, B2, B3> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.eq(head.t), ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<List<T>, List<T>>(
        matchers, 1, new ListConsHeadTailFieldExtractor<>()).decomposeFirst(tail);
  }
  ...
  public static <T> DecomposableMatchBuilder1<List<T>, T> headTail(
      MatchesAny<T> head, MatchesExact<List<T>> tail) {
  ...
  public static <T> DecomposableMatchBuilder2<List<T>, T, List<T>> headTail(
      MatchesAny<T> head, MatchesAny<List<T>> tail) {
   ...
   */
  public static <T> DecomposableMatchBuilder1<List<T>, T> headTail(
      MatchesAny<T> head, DecomposableMatchBuilder0<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, T, List<T>>(
  ...
  public static <T, B1> DecomposableMatchBuilder2<List<T>, T, B1> headTail(
      MatchesAny<T> head, DecomposableMatchBuilder1<List<T>, B1> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, T, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>()).decomposeSecond(tail);
  }
  ...
  public static <T, B1, B2> DecomposableMatchBuilder3<List<T>, T, B1, B2> headTail(
      MatchesAny<T> head, DecomposableMatchBuilder2<List<T>, B1, B2> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, T, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>()).decomposeSecond(tail);
  }
   ...
   * <p>If matched, the {@code head} value is decomposed to 0.
   */
  public static <T, ET extends T> DecomposableMatchBuilder0<List<T>> headTail(
      DecomposableMatchBuilder0<ET> head, MatchesExact<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.eq(tail.t));
    return new DecomposableMatchBuilder1<List<T>, ET>(
   ...
   */
  public static <T, ET extends T> DecomposableMatchBuilder1<List<T>, List<T>> headTail(
      DecomposableMatchBuilder0<ET> head, MatchesAny<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
   ...
   */
  public static <T, ET extends T> DecomposableMatchBuilder0<List<T>> headTail(
      DecomposableMatchBuilder0<ET> head, DecomposableMatchBuilder0<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
   ...
   * 1.
   */
  public static <T, ET extends T, B1> DecomposableMatchBuilder1<List<T>, B1> headTail(
      DecomposableMatchBuilder0<ET> head, DecomposableMatchBuilder1<List<T>, B1> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
   ...
   * 2.
   */
  public static <T, ET extends T, B1, B2> DecomposableMatchBuilder2<List<T>, B1, B2> headTail(
      DecomposableMatchBuilder0<ET> head, DecomposableMatchBuilder2<List<T>, B1, B2> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
   ...
   * 3.
   */
  public static <T, ET extends T, B1, B2, B3> DecomposableMatchBuilder3<List<T>, B1, B2, B3> headTail(
      DecomposableMatchBuilder0<ET> head, DecomposableMatchBuilder3<List<T>, B1, B2, B3> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
   ...
   * <p>If matched, the {@code head} value is decomposed to 1.
   */
  public static <T, ET extends T, A1> DecomposableMatchBuilder1<List<T>, A1> headTail(
      DecomposableMatchBuilder1<ET, A1> head, MatchesExact<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.eq(tail.t));
    return new DecomposableMatchBuilder1<List<T>, ET>(
        matchers, 0, new ListConsHeadTailFieldExtractor<>()).decomposeFirst(head);
  }
   ...
   */
  public static <T, ET extends T, A1> DecomposableMatchBuilder2<List<T>, A1, List<T>> headTail(
      DecomposableMatchBuilder1<ET, A1> head, MatchesAny<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>()).decomposeFirst(head);
  }
   ...
   */
  public static <T, ET extends T, A1> DecomposableMatchBuilder1<List<T>, A1> headTail(
      DecomposableMatchBuilder1<ET, A1> head, DecomposableMatchBuilder0<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
   ...
   * 1.
   */
  public static <T, ET extends T, A1, B1> DecomposableMatchBuilder2<List<T>, A1, B1> headTail(
      DecomposableMatchBuilder1<ET, A1> head, DecomposableMatchBuilder1<List<T>, B1> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
   ...
   * 2.
   */
  public static <T, ET extends T, A1, B1, B2> DecomposableMatchBuilder3<List<T>, A1, B1, B2> headTail(
      DecomposableMatchBuilder1<ET, A1> head, DecomposableMatchBuilder2<List<T>, B1, B2> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
   ...
   * <p>If matched, the {@code head} value is decomposed to 2.
   */
  public static <T, ET extends T, A1, A2> DecomposableMatchBuilder2<List<T>, A1, A2> headTail(
      DecomposableMatchBuilder2<ET, A1, A2> head, MatchesExact<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.eq(tail.t));
    return new DecomposableMatchBuilder1<List<T>, ET>(
        matchers, 0, new ListConsHeadTailFieldExtractor<>()).decomposeFirst(head);
  }
   ...
   */
  public static <T, ET extends T, A1, A2> DecomposableMatchBuilder3<List<T>, A1, A2, List<T>> headTail(
      DecomposableMatchBuilder2<ET, A1, A2> head, MatchesAny<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>()).decomposeFirst(head);
  }
   ...
   */
  public static <T, ET extends T, A1, A2> DecomposableMatchBuilder2<List<T>, A1, A2> headTail(
      DecomposableMatchBuilder2<ET, A1, A2> head, DecomposableMatchBuilder0<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
   ...
   * 1.
   */
  public static <T, ET extends T, A1, A2, B1> DecomposableMatchBuilder3<List<T>, A1, A2, B1> headTail(
      DecomposableMatchBuilder2<ET, A1, A2> head, DecomposableMatchBuilder1<List<T>, B1> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
   ...
   * <p>If matched, the {@code head} value is decomposed to 3.
   */
  public static <T, ET extends T, A1, A2, A3> DecomposableMatchBuilder3<List<T>, A1, A2, A3> headTail(
      DecomposableMatchBuilder3<ET, A1, A2, A3> head, MatchesExact<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.eq(tail.t));
    return new DecomposableMatchBuilder1<List<T>, ET>(
        matchers, 0, new ListConsHeadTailFieldExtractor<>()).decomposeFirst(head);
  }
   ...
   */
  public static <T, ET extends T, A1, A2, A3> DecomposableMatchBuilder3<List<T>, A1, A2, A3> headTail(
      DecomposableMatchBuilder3<ET, A1, A2, A3> head, DecomposableMatchBuilder0<List<T>> tail) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder2<List<T>, ET, List<T>>(
        matchers, Tuple2.of(0, 1), new ListConsHeadTailFieldExtractor<>())
        .decomposeFirstAndSecond(head, tail);
