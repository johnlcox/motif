...
public final class Tuple3Cases {
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code c} value is extracted.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code c} value is decomposed to 0.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code c} value is decomposed to 1.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code c} value is decomposed to 2.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code c} value is decomposed to 3.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is extracted and the {@code c} value is extracted.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is extracted and the {@code c} value is decomposed to 0.
   *
   */
  public static <A, B, C> DecomposableMatchBuilder1<Tuple3<A, B, C>, B> tuple3(
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is extracted and the {@code c} value is decomposed to 1.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is extracted and the {@code c} value is decomposed to 2.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is decomposed to 0 and the {@code c} value is extracted.
   *
   */
  public static <A, B, C> DecomposableMatchBuilder1<Tuple3<A, B, C>, C> tuple3(
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is decomposed to 0 and the {@code c} value is decomposed to
   * 0.
   *
   */
  public static <A, B, C> DecomposableMatchBuilder0<Tuple3<A, B, C>> tuple3(
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is decomposed to 1 and the {@code c} value is extracted.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is decomposed to 1 and the {@code c} value is decomposed to
   * 0.
   *
   */
  public static <A, B, C, B1> DecomposableMatchBuilder1<Tuple3<A, B, C>, B1> tuple3(
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is decomposed to 2 and the {@code c} value is extracted.
   *
   */
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is decomposed to 2 and the {@code c} value is decomposed to
   * 0.
   *
   */
  public static <A, B, C, B1, B2> DecomposableMatchBuilder2<Tuple3<A, B, C>, B1, B2> tuple3(
   ...
   * Matches a tuple of 2 elements.
   *
   * <p>If matched,  and the {@code b} value is decomposed to 3 and the {@code c} value is decomposed to
   * 0.
   *
   */
  public static <A, B, C, B1, B2, B3> DecomposableMatchBuilder3<Tuple3<A, B, C>, B1, B2, B3> tuple3(
  ...
  public static <A, B, C> DecomposableMatchBuilder0<Tuple3<A, B, C>> tuple3(
    ...
    List<Matcher<Object>> matchers =
        Lists.of(ArgumentMatchers.any(), ArgumentMatchers.any(), ArgumentMatchers.any());
    return new DecomposableMatchBuilder3<Tuple3<A, B, C>, A, B, C>(
        matchers, Tuple3.of(0, 1, 2), new Tuple3FieldExtractor<>()).decomposeFirstAndSecondAndThird(
        a, b, c);
  }
