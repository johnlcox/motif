...
public final class OptionalCases {
   ...
   */
  public static <T, ET extends T> DecomposableMatchBuilder0<Optional<T>> some(
      DecomposableMatchBuilder0<ET> t) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<Optional<T>, ET>(
   ...
   */
  public static <T, ET extends T, A1> DecomposableMatchBuilder1<Optional<T>, A1> some(
      DecomposableMatchBuilder1<ET, A1> t) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<Optional<T>, ET>(
        matchers, 0, new OptionalFieldExtractor<>()).decomposeFirst(t);
  }
   ...
   */
  public static <T, ET extends T, A1, A2> DecomposableMatchBuilder2<Optional<T>, A1, A2> some(
      DecomposableMatchBuilder2<ET, A1, A2> t) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<Optional<T>, ET>(
        matchers, 0, new OptionalFieldExtractor<>()).decomposeFirst(t);
  }
   ...
   */
  public static <T, ET extends T, A1, A2, A3> DecomposableMatchBuilder3<Optional<T>, A1, A2, A3> some(
      DecomposableMatchBuilder3<ET, A1, A2, A3> t) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<Optional<T>, ET>(
        matchers, 0, new OptionalFieldExtractor<>()).decomposeFirst(t);
  }
