...
public final class OptionalCases {
   ...
   */
  public static <T> DecomposableMatchBuilder0<Optional<T>> some(DecomposableMatchBuilder0<T> t) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<Optional<T>, T>(matchers, 0, new OptionalFieldExtractor<>()).decomposeFirst(t);
  }
   ...
   */
  public static <T, A1> DecomposableMatchBuilder1<Optional<T>, A1> some(DecomposableMatchBuilder1<T, A1> t) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<Optional<T>, T>(matchers, 0, new OptionalFieldExtractor<>()).decomposeFirst(t);
  }
   ...
   */
  public static <T, A1, A2> DecomposableMatchBuilder2<Optional<T>, A1, A2> some(DecomposableMatchBuilder2<T, A1, A2> t) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<Optional<T>, T>(matchers, 0, new OptionalFieldExtractor<>()).decomposeFirst(t);
  }
   ...
   */
  public static <T, A1, A2, A3> DecomposableMatchBuilder3<Optional<T>, A1, A2, A3> some(DecomposableMatchBuilder3<T, A1, A2, A3> t) {
    List<Matcher<Object>> matchers = Lists.of(ArgumentMatchers.any());
    return new DecomposableMatchBuilder1<Optional<T>, T>(matchers, 0, new OptionalFieldExtractor<>()).decomposeFirst(t);
  }
}
